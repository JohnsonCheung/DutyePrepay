...
'            mJoin = Join(mAy, " and ")
'
'            mSql = Fmt("Update [{0}] Set {1} Where {2}", _
'                    TAft, mSetLst, mWhere)
'            Stop
''            If pIsChk Then
...
'
'''''mSql41
'mSql41 = Fmt(mSql41, A0, A1, A2, A3, A4)
'
...
'
'mSql51 = Fmt(mSql51, A0, A1, A2, A3, A4)
'''====Create queries & Run
...
'If Crt_TqRel("qryCmp_04_0_Output", T2, AyToStr(mAnFld_CmnKey, , ";"), AyToStr(mAy, , ";")) Then ss.A 34: GoTo E
'
''OpnQry
